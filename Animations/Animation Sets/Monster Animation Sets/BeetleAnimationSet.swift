...
/// A `DirectionalAnimationSet` subclass for the `Beetle` entity.
///
class BeetleAnimationSet: DirectionalAnimationSet, TextureUser, AnimationUser {
    
    /// The identifier to be used when creating the object.
    ///
    private static let _identifier = "Beetle"
    ...
    static var textureNames: Set<String> {
        let frames: [(name: String, first: Int, last: Int)] = [
            ("Beetle_Idle_Back_", 1, 6),
            ("Beetle_Idle_Front_", 1, 6),
            ("Beetle_Idle_Side_", 1, 6),
            
            ("Beetle_Walk_Back_", 1, 7),
            ("Beetle_Walk_Front_", 1, 7),
            ("Beetle_Walk_Side_", 1, 7),
            
            ("Beetle_Attack_Back_", 1, 8),
            ("Beetle_Attack_Front_", 1, 8),
            ("Beetle_Attack_Side_", 1, 8)]
    ...
    ///
    init() {
        super.init(identifier: BeetleAnimationSet._identifier)
    ...
    private func addIdle() {
        ...
        images = ImageArray.createFrom(baseName: "Beetle_Idle_Back_", first: 1, last: 6, reversing: true,
                                       dropFirst: false)
        ...
        images = ImageArray.createFrom(baseName: "Beetle_Idle_Front_", first: 1, last: 6, reversing: true,
                                       dropFirst: false)
        ...
        images = ImageArray.createFrom(baseName: "Beetle_Idle_Side_", first: 1, last: 6, reversing: true,
                                       dropFirst: false)
    ...
    private func addWalk() {
        ...
        images = ImageArray.createFrom(baseName: "Beetle_Walk_Back_", first: 1, last: 7, reversing: true)
        let north = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                     repeatForever: true)
        addAnimation(north, named: .walk, forDirection: .north)

        images = ImageArray.createFrom(baseName: "Beetle_Walk_Front_", first: 1, last: 7, reversing: true)
        let south = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                     repeatForever: true)
        addAnimation(south, named: .walk, forDirection: .south)

        images = ImageArray.createFrom(baseName: "Beetle_Walk_Side_", first: 1, last: 7, reversing: true)
        let east = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                    repeatForever: true)
    ...
    private func addAttack() {
        ...
        images = ImageArray.createFrom(baseName: "Beetle_Attack_Back_", first: 1, last: 8, reversing: true,
                                       dropFirst: false)
        let north = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                     repeatForever: false)
        addAnimation(north, named: .attack, forDirection: .north)

        images = ImageArray.createFrom(baseName: "Beetle_Attack_Front_", first: 1, last: 8, reversing: true,
                                       dropFirst: false)
        let south = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                     repeatForever: false)
        addAnimation(south, named: .attack, forDirection: .south)

        images = ImageArray.createFrom(baseName: "Beetle_Attack_Side_", first: 1, last: 8, reversing: true,
                                       dropFirst: false)
        let east = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                    repeatForever: false)
