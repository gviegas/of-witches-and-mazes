...
/// A `DirectionalAnimationSet` subclass for the `DeathCap` entity.
///
class DeathCapAnimationSet: DirectionalAnimationSet, TextureUser, AnimationUser {
    
    /// The identifier to be used when creating the object.
    ///
    private static let _identifier = "Death Cap"
    ...
    static var textureNames: Set<String> {
        let frames: [(name: String, first: Int, last: Int)] = [
            ("Death_Cap_Idle_Back_", 1, 11),
            ("Death_Cap_Idle_Front_", 1, 11),
            ("Death_Cap_Idle_Side_", 1, 11),
            
            ("Death_Cap_Walk_Back_", 1, 11),
            ("Death_Cap_Walk_Front_", 1, 11),
            ("Death_Cap_Walk_Side_", 1, 11)]
    ...
    ///
    init() {
        super.init(identifier: DeathCapAnimationSet._identifier)
    ...
    private func addIdle() {
        ...
        images = ImageArray.createFrom(baseName: "Death_Cap_Idle_Back_", first: 1, last: 11, reversing: true,
                                       dropFirst: false)
        ...
        images = ImageArray.createFrom(baseName: "Death_Cap_Idle_Front_", first: 1, last: 11, reversing: true,
                                       dropFirst: false)
        ...
        images = ImageArray.createFrom(baseName: "Death_Cap_Idle_Side_", first: 1, last: 11, reversing: true,
                                       dropFirst: false)
    ...
    private func addWalk() {
        ...
        images = ImageArray.createFrom(baseName: "Death_Cap_Walk_Back_", first: 1, last: 11, reversing: true)
        ...
        images = ImageArray.createFrom(baseName: "Death_Cap_Walk_Front_", first: 1, last: 11, reversing: true)
        ...
        images = ImageArray.createFrom(baseName: "Death_Cap_Walk_Side_", first: 1, last: 11, reversing: true)
    ...
    private func addQuell() {
        ...
        images = ["Death_Cap_Idle_Front_11"]
