...
/// A `DirectionalAnimationSet` subclass for the `Feral` entity.
///
class FeralAnimationSet: DirectionalAnimationSet, TextureUser, AnimationUser {
    
    /// The identifier to be used when creating the object.
    ///
    private static let _identifier = "Feral"
    ...
    static var textureNames: Set<String> {
        let frames: [(name: String, first: Int, last: Int)] = [
            ("Feral_Idle_Back_", 1, 6),
            ("Feral_Idle_Front_", 1, 6),
            ("Feral_Idle_Side_", 1, 6),
            
            ("Feral_Walk_Back_", 1, 11),
            ("Feral_Walk_Front_", 1, 11),
            ("Feral_Walk_Side_", 1, 11),
            
            ("Feral_Attack_Back_", 1, 6),
            ("Feral_Attack_Front_", 1, 6),
            ("Feral_Attack_Side_", 1, 6)]
    ...
    ///
    init() {
        super.init(identifier: FeralAnimationSet._identifier)
    ...
    private func addIdle() {
        ...
        images = ImageArray.createFrom(baseName: "Feral_Idle_Back_", first: 1, last: 6, reversing: true,
                                       dropFirst: false)
        ...
        images = ImageArray.createFrom(baseName: "Feral_Idle_Front_", first: 1, last: 6, reversing: true,
                                       dropFirst: false)
        images.append(contentsOf: images)
        ...
        images = ImageArray.createFrom(baseName: "Feral_Idle_Side_", first: 1, last: 6, reversing: true,
                                       dropFirst: false)
        images.append(contentsOf: images)
    ...
    private func addWalk() {
        ...
        images = ImageArray.createFrom(baseName: "Feral_Walk_Back_", first: 1, last: 11, reversing: true)
        let north = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                     repeatForever: true)
        addAnimation(north, named: .walk, forDirection: .north)
        
        images = ImageArray.createFrom(baseName: "Feral_Walk_Front_", first: 1, last: 11, reversing: true)
        let south = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                     repeatForever: true)
        addAnimation(south, named: .walk, forDirection: .south)
        
        images = ImageArray.createFrom(baseName: "Feral_Walk_Side_", first: 1, last: 11, reversing: true)
        let east = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                    repeatForever: true)
    ...
    private func addRangedAttack() {
        ...
        images = ImageArray.createFrom(baseName: "Feral_Attack_Back_", first: 1, last: 6, reversing: true,
                                       dropFirst: false)
        let north = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                     repeatForever: false)
        addAnimation(north, named: .rangedAttack, forDirection: .north)
        
        images = ImageArray.createFrom(baseName: "Feral_Attack_Front_", first: 1, last: 6, reversing: true,
                                       dropFirst: false)
        let south = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                     repeatForever: false)
        addAnimation(south, named: .rangedAttack, forDirection: .south)
        
        images = ImageArray.createFrom(baseName: "Feral_Attack_Side_", first: 1, last: 6, reversing: true,
                                       dropFirst: false)
        let east = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                    repeatForever: false)
