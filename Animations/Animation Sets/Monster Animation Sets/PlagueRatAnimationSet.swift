...
/// A `DirectionalAnimationSet` subclass for the `PlagueRat` entity.
///
class PlagueRatAnimationSet: DirectionalAnimationSet, TextureUser, AnimationUser {
    
    /// The identifier to be used when creating the object.
    ///
    private static let _identifier = "Plague Rat"
    ...
    static var textureNames: Set<String> {
        let frames: [(name: String, first: Int, last: Int)] = [
            ("Plague_Rat_Idle_Back_", 1, 6),
            ("Plague_Rat_Idle_Front_", 1, 6),
            ("Plague_Rat_Idle_Side_", 1, 6),
            
            ("Plague_Rat_Walk_Back_", 1, 10),
            ("Plague_Rat_Walk_Front_", 1, 10),
            ("Plague_Rat_Walk_Side_", 1, 10),
            
            ("Plague_Rat_Attack_Back_", 1, 10),
            ("Plague_Rat_Attack_Front_", 1, 10),
            ("Plague_Rat_Attack_Side_", 1, 10)]
    ...
    ///
    init() {
        super.init(identifier: PlagueRatAnimationSet._identifier)
    ...
    private func addIdle() {
        ...
        images = ImageArray.createFrom(baseName: "Plague_Rat_Idle_Back_", first: 1, last: 6, reversing: true,
                                       dropFirst: false)
        ...
        images = ImageArray.createFrom(baseName: "Plague_Rat_Idle_Front_", first: 1, last: 6, reversing: true,
                                       dropFirst: false)
        ...
        images = ImageArray.createFrom(baseName: "Plague_Rat_Idle_Side_", first: 1, last: 6, reversing: true,
                                       dropFirst: false)
    ...
    private func addWalk() {
        ...
        images = ImageArray.createFrom(baseName: "Plague_Rat_Walk_Back_", first: 1, last: 10, reversing: true)
        let north = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                     repeatForever: true)
        addAnimation(north, named: .walk, forDirection: .north)
        
        images = ImageArray.createFrom(baseName: "Plague_Rat_Walk_Front_", first: 1, last: 10, reversing: true)
        let south = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                     repeatForever: true)
        addAnimation(south, named: .walk, forDirection: .south)
        
        images = ImageArray.createFrom(baseName: "Plague_Rat_Walk_Side_", first: 1, last: 10, reversing: true)
        let east = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                    repeatForever: true)
    ...
    private func addAttack() {
        ...
        images = ImageArray.createFrom(baseName: "Plague_Rat_Attack_Back_", first: 1, last: 10, reversing: true,
                                       dropFirst: false)
        let north = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                     repeatForever: false)
        addAnimation(north, named: .attack, forDirection: .north)
        
        images = ImageArray.createFrom(baseName: "Plague_Rat_Attack_Front_", first: 1, last: 10, reversing: true,
                                       dropFirst: false)
        let south = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                     repeatForever: false)
        addAnimation(south, named: .attack, forDirection: .south)
        
        images = ImageArray.createFrom(baseName: "Plague_Rat_Attack_Side_", first: 1, last: 10, reversing: true,
                                       dropFirst: false)
        let east = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                    repeatForever: false)
    ...
    private func addQuell() {
        ...
        images = ["Plague_Rat_Idle_Front_6"]
