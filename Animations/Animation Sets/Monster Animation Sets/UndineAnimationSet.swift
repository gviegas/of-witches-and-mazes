...
/// A `DirectionalAnimationSet` subclass for the `Undine` entity.
///
class UndineAnimationSet: DirectionalAnimationSet, TextureUser, AnimationUser {
    
    /// The identifier to be used when creating the object.
    ///
    private static let _identifier = "Undine"
    ...
    static var textureNames: Set<String> {
        let frames: [(name: String, first: Int, last: Int)] = [
            ("Undine_Idle_Back_", 1, 6),
            ("Undine_Idle_Front_", 1, 6),
            ("Undine_Idle_Side_", 1, 6),
            
            ("Undine_Walk_Back_", 1, 11),
            ("Undine_Walk_Front_", 1, 11),
            ("Undine_Walk_Side_", 1, 11),
            
            ("Undine_Cast_Back_", 1, 13),
            ("Undine_Cast_Front_", 1, 13),
            ("Undine_Cast_Side_", 1, 13)]
    ...
    ///
    init() {
        super.init(identifier: UndineAnimationSet._identifier)
    ...
    private func addIdle() {
        ...
        images = ImageArray.createFrom(baseName: "Undine_Idle_Back_", first: 1, last: 6, reversing: true,
                                       dropFirst: false)
        ...
        images = ImageArray.createFrom(baseName: "Undine_Idle_Front_", first: 1, last: 6, reversing: true,
                                       dropFirst: false)
        ...
        images = ImageArray.createFrom(baseName: "Undine_Idle_Side_", first: 1, last: 6, reversing: true,
                                       dropFirst: false)
    ...
    private func addWalk() {
        ...
        images = ImageArray.createFrom(baseName: "Undine_Walk_Back_", first: 1, last: 11, reversing: true)
        let north = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                     repeatForever: true)
        addAnimation(north, named: .walk, forDirection: .north)
        
        images = ImageArray.createFrom(baseName: "Undine_Walk_Front_", first: 1, last: 11, reversing: true)
        let south = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                     repeatForever: true)
        addAnimation(south, named: .walk, forDirection: .south)
        
        images = ImageArray.createFrom(baseName: "Undine_Walk_Side_", first: 1, last: 11, reversing: true)
        let east = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                    repeatForever: true)
    ...
    private func addCast() {
        ...
        images = ImageArray.createFrom(baseName: "Undine_Cast_Back_", first: 1, last: 13)
        ...
        images = ImageArray.createFrom(baseName: "Undine_Cast_Front_", first: 1, last: 13)
        ...
        images = ImageArray.createFrom(baseName: "Undine_Cast_Side_", first: 1, last: 13)
    ...
    private func addCastEnd() {
        ...
        images = ImageArray.createFrom(baseName: "Undine_Cast_Back_", first: 13, last: 1)
        let north = TextureAnimation(images: images, timePerFrame: 0.033, replaceable: true, flipped: false,
                                     repeatForever: false)
        addAnimation(north, named: .castEnd, forDirection: .north)
        
        images = ImageArray.createFrom(baseName: "Undine_Cast_Front_", first: 13, last: 1)
        let south = TextureAnimation(images: images, timePerFrame: 0.033, replaceable: true, flipped: false,
                                     repeatForever: false)
        addAnimation(south, named: .castEnd, forDirection: .south)
        
        images = ImageArray.createFrom(baseName: "Undine_Cast_Side_", first: 13, last: 1)
        let east = TextureAnimation(images: images, timePerFrame: 0.033, replaceable: true, flipped: false,
                                    repeatForever: false)
