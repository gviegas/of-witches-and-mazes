...
/// A `DirectionalAnimationSet` subclass for the `Fairy` entity.
///
class FairyAnimationSet: DirectionalAnimationSet, TextureUser, AnimationUser {
    
    /// The identifier to be used when creating the object.
    ///
    private static let _identifier = "Fairy"
    ...
    static var textureNames: Set<String> {
        let frames: [(name: String, first: Int, last: Int)] = [
            ("Fairy_Fly_Back_", 1, 7),
            ("Fairy_Fly_Front_", 1, 7),
            ("Fairy_Fly_Side_", 1, 7),
            
            ("Fairy_Attack_Back_", 1, 7),
            ("Fairy_Attack_Front_", 1, 7),
            ("Fairy_Attack_Side_", 1, 7)]
    ...
    ///
    init() {
        super.init(identifier: FairyAnimationSet._identifier)
    ...
    private func addIdle() {
        ...
        images = ImageArray.createFrom(baseName: "Fairy_Fly_Back_", first: 1, last: 7, reversing: true)
        ...
        images = ImageArray.createFrom(baseName: "Fairy_Fly_Front_", first: 1, last: 7, reversing: true)
        ...
        images = ImageArray.createFrom(baseName: "Fairy_Fly_Side_", first: 1, last: 7, reversing: true)
    ...
    private func addAttack() {
        ...
        images = ImageArray.createFrom(baseName: "Fairy_Attack_Back_", first: 1, last: 7, reversing: true)
        let north = TextureAnimation(images: images, timePerFrame: 0.033, replaceable: true, flipped: false,
                                     repeatForever: true)
        addAnimation(north, named: .attack, forDirection: .north)

        images = ImageArray.createFrom(baseName: "Fairy_Attack_Front_", first: 1, last: 7, reversing: true)
        let south = TextureAnimation(images: images, timePerFrame: 0.033, replaceable: true, flipped: false,
                                     repeatForever: true)
        addAnimation(south, named: .attack, forDirection: .south)

        images = ImageArray.createFrom(baseName: "Fairy_Attack_Side_", first: 1, last: 7, reversing: true)
        let east = TextureAnimation(images: images, timePerFrame: 0.033, replaceable: true, flipped: false,
                                    repeatForever: true)
