...
/// A `DirectionalAnimationSet` subclass for the `Defiler` entity.
///
class DefilerAnimationSet: DirectionalAnimationSet, TextureUser, AnimationUser {
    
    /// The identifier to be used when creating the object.
    ///
    private static let _identifier = "Defiler"
    ...
    static var textureNames: Set<String> {
        let frames: [(name: String, first: Int, last: Int)] = [
            ("Defiler_Idle_Back_", 1, 6),
            ("Defiler_Idle_Front_", 1, 6),
            ("Defiler_Idle_Side_", 1, 6),
            
            ("Defiler_Walk_Back_", 1, 11),
            ("Defiler_Walk_Front_", 1, 11),
            ("Defiler_Walk_Side_", 1, 11),
            
            ("Defiler_Attack_Back_", 1, 9),
            ("Defiler_Attack_Front_", 1, 9),
            ("Defiler_Attack_Side_", 1, 9)]
    ...
    ///
    init() {
        super.init(identifier: DefilerAnimationSet._identifier)
    ...
    private func addIdle() {
        ...
        images = ImageArray.createFrom(baseName: "Defiler_Idle_Back_", first: 1, last: 6, reversing: true,
                                       dropFirst: false)
        ...
        images = ImageArray.createFrom(baseName: "Defiler_Idle_Front_", first: 1, last: 6, reversing: true,
                                       dropFirst: false)
        ...
        images = ImageArray.createFrom(baseName: "Defiler_Idle_Side_", first: 1, last: 6, reversing: true,
                                       dropFirst: false)
    ...
    private func addWalk() {
        ...
        images = ImageArray.createFrom(baseName: "Defiler_Walk_Back_", first: 1, last: 11, reversing: true)
        ...
        images = ImageArray.createFrom(baseName: "Defiler_Walk_Front_", first: 1, last: 11, reversing: true)
        ...
        images = ImageArray.createFrom(baseName: "Defiler_Walk_Side_", first: 1, last: 11, reversing: true)
    ...
    private func addAttack() {
        ...
        images = ImageArray.createFrom(baseName: "Defiler_Attack_Back_", first: 1, last: 9)
        let north = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                     repeatForever: false)
        addAnimation(north, named: .attack, forDirection: .north)

        images = ImageArray.createFrom(baseName: "Defiler_Attack_Front_", first: 1, last: 9)
        let south = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                     repeatForever: false)
        addAnimation(south, named: .attack, forDirection: .south)

        images = ImageArray.createFrom(baseName: "Defiler_Attack_Side_", first: 1, last: 9)
        let east = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                    repeatForever: false)
