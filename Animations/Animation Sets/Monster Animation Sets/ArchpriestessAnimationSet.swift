//
//  ArchpriestessAnimationSet.swift
...
/// A `DirectionalAnimationSet` subclass for the `Archpriestess` entity.
///
class ArchpriestessAnimationSet: DirectionalAnimationSet, TextureUser, AnimationUser {
    
    /// The identifier to be used when creating the object.
    ///
    private static let _identifier = "Archpriestess"
    ...
    static var textureNames: Set<String> {
        let frames: [(name: String, first: Int, last: Int)] = [
            ("Archpriestess_Idle_Back_", 1, 7),
            ("Archpriestess_Idle_Front_", 1, 7),
            ("Archpriestess_Idle_Side_", 1, 7),
            
            ("Archpriestess_Walk_Back_", 1, 11),
            ("Archpriestess_Walk_Front_", 1, 11),
            ("Archpriestess_Walk_Side_", 1, 11),
            
            ("Archpriestess_Cast_Back_", 1, 7),
            ("Archpriestess_Cast_Front_", 1, 7),
            ("Archpriestess_Cast_Side_", 1, 7)]
    ...
    ///
    init() {
        super.init(identifier: ArchpriestessAnimationSet._identifier)
    ...
    private func addIdle() {
        ...
        images = ImageArray.createFrom(baseName: "Archpriestess_Idle_Back_", first: 1, last: 7, reversing: true,
                                       dropFirst: false)
        ...
        images = ImageArray.createFrom(baseName: "Archpriestess_Idle_Front_", first: 1, last: 7, reversing: true,
                                       dropFirst: false)
        ...
        images = ImageArray.createFrom(baseName: "Archpriestess_Idle_Side_", first: 1, last: 7, reversing: true,
                                       dropFirst: false)
    ...
    private func addWalk() {
        ...
        images = ImageArray.createFrom(baseName: "Archpriestess_Walk_Back_", first: 1, last: 11, reversing: true)
        let north = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                     repeatForever: true)
        addAnimation(north, named: .walk, forDirection: .north)
        
        images = ImageArray.createFrom(baseName: "Archpriestess_Walk_Front_", first: 1, last: 11, reversing: true)
        let south = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                     repeatForever: true)
        addAnimation(south, named: .walk, forDirection: .south)
        
        images = ImageArray.createFrom(baseName: "Archpriestess_Walk_Side_", first: 1, last: 11, reversing: true)
        let east = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                    repeatForever: true)
    ...
    private func addCast() {
        ...
        images = ImageArray.createFrom(baseName: "Archpriestess_Cast_Back_", first: 1, last: 7)
        let north = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                     repeatForever: false)
        addAnimation(north, named: .cast, forDirection: .north)
        
        images = ImageArray.createFrom(baseName: "Archpriestess_Cast_Front_", first: 1, last: 7)
        let south = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                     repeatForever: false)
        addAnimation(south, named: .cast, forDirection: .south)
        
        images = ImageArray.createFrom(baseName: "Archpriestess_Cast_Side_", first: 1, last: 7)
        let east = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                    repeatForever: false)
    ...
    private func addCastEnd() {
        ...
        images = ImageArray.createFrom(baseName: "Archpriestess_Cast_Back_", first: 7, last: 1)
        let north = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                     repeatForever: false)
        addAnimation(north, named: .castEnd, forDirection: .north)
        
        images = ImageArray.createFrom(baseName: "Archpriestess_Cast_Front_", first: 7, last: 1)
        let south = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                     repeatForever: false)
        addAnimation(south, named: .castEnd, forDirection: .south)
        
        images = ImageArray.createFrom(baseName: "Archpriestess_Cast_Side_", first: 7, last: 1)
        let east = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                    repeatForever: false)
    ...
    private func addQuell() {
        ...
        images = ["Archpriestess_Idle_Back_5"]
        ...
        images = ["Archpriestess_Idle_Front_5"]
        ...
        images = ["Archpriestess_Idle_Side_5"]
