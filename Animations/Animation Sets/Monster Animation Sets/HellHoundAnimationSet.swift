...
/// A `DirectionalAnimationSet` subclass for the `HellHound` entity.
///
class HellHoundAnimationSet: DirectionalAnimationSet, TextureUser, AnimationUser {
    
    /// The identifier to be used when creating the object.
    ///
    private static let _identifier = "Hell Hound"
    ...
    static var textureNames: Set<String> {
        let frames: [(name: String, first: Int, last: Int)] = [
            ("Hell_Hound_Idle_Back_", 1, 6),
            ("Hell_Hound_Idle_Front_", 1, 6),
            ("Hell_Hound_Idle_Side_", 1, 6),
            
            ("Hell_Hound_Walk_Back_", 1, 11),
            ("Hell_Hound_Walk_Front_", 1, 11),
            ("Hell_Hound_Walk_Side_", 1, 11),
            
            ("Hell_Hound_Attack_Back_", 1, 9),
            ("Hell_Hound_Attack_Front_", 1, 9),
            ("Hell_Hound_Attack_Side_", 1, 9)]
    ...
    ///
    init() {
        super.init(identifier: HellHoundAnimationSet._identifier)
    ...
    private func addIdle() {
        ...
        images = ImageArray.createFrom(baseName: "Hell_Hound_Idle_Back_", first: 1, last: 6, reversing: true,
                                       dropFirst: false)
        ...
        images = ImageArray.createFrom(baseName: "Hell_Hound_Idle_Front_", first: 1, last: 6, reversing: true,
                                       dropFirst: false)
        ...
        images = ImageArray.createFrom(baseName: "Hell_Hound_Idle_Side_", first: 1, last: 6, reversing: true,
                                       dropFirst: false)
    ...
    private func addWalk() {
        ...
        images = ImageArray.createFrom(baseName: "Hell_Hound_Walk_Back_", first: 1, last: 11, reversing: true)
        let north = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                     repeatForever: true)
        addAnimation(north, named: .walk, forDirection: .north)
        
        images = ImageArray.createFrom(baseName: "Hell_Hound_Walk_Front_", first: 1, last: 11, reversing: true)
        let south = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                     repeatForever: true)
        addAnimation(south, named: .walk, forDirection: .south)
        
        images = ImageArray.createFrom(baseName: "Hell_Hound_Walk_Side_", first: 1, last: 11, reversing: true)
        let east = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                    repeatForever: true)
    ...
    private func addAttack() {
        ...
        images = ImageArray.createFrom(baseName: "Hell_Hound_Attack_Back_", first: 1, last: 9, reversing: true,
                                       dropFirst: false)
        ...
        images = ImageArray.createFrom(baseName: "Hell_Hound_Attack_Front_", first: 1, last: 9, reversing: true,
                                       dropFirst: false)
        ...
        images = ImageArray.createFrom(baseName: "Hell_Hound_Attack_Side_", first: 1, last: 9, reversing: true,
                                       dropFirst: false)
    ...
    private func addQuell() {
        ...
        images = ["Hell_Hound_Idle_Front_2"]
