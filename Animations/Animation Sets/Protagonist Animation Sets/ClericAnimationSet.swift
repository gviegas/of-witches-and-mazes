...
/// A `DirectionalAnimationSet` subclass for the `Cleric` entity.
///
class ClericAnimationSet: DirectionalAnimationSet, TextureUser, AnimationUser {
    
    /// The identifier to be used when creating the object.
    ///
    private static let _identifier = "Cleric"
    ...
    static var textureNames: Set<String> {
        let frames: [(name: String, first: Int, last: Int)] = [
            ("Cleric_Idle_Back_", 1, 7),
            ("Cleric_Idle_Front_", 1, 7),
            ("Cleric_Idle_Side_", 1, 7),
            
            ("Cleric_Walk_Back_", 1, 11),
            ("Cleric_Walk_Front_", 1, 11),
            ("Cleric_Walk_Side_", 1, 11),
            
            ("Cleric_Lift_Back_", 1, 5),
            ("Cleric_Lift_Front_", 1, 5),
            ("Cleric_Lift_Side_", 1, 5),
            
            ("Cleric_Carry_Back_", 1, 11),
            ("Cleric_Carry_Front_", 1, 11),
            ("Cleric_Carry_Side_", 1, 11),
            
            ("Cleric_Hurl_Back_", 1, 5),
            ("Cleric_Hurl_Front_", 1, 5),
            ("Cleric_Hurl_Side_", 1, 5),
            
            ("Cleric_Attack_Back_", 1, 7),
            ("Cleric_Attack_Front_", 1, 7),
            ("Cleric_Attack_Side_", 1, 7),
            
            ("Cleric_Aim_Back_", 1, 5),
            ("Cleric_Aim_Front_", 1, 5),
            ("Cleric_Aim_Side_", 1, 5),
            
            ("Cleric_Shoot_Back_", 1, 5),
            ("Cleric_Shoot_Front_", 1, 5),
            ("Cleric_Shoot_Side_", 1, 5),
            
            ("Cleric_Direct_Back_", 1, 5),
            ("Cleric_Direct_Front_", 1, 5),
            ("Cleric_Direct_Side_", 1, 5),
            
            ("Cleric_Toss_Back_", 1, 5),
            ("Cleric_Toss_Front_", 1, 5),
            ("Cleric_Toss_Side_", 1, 5),
            
            ("Cleric_Use_Back_", 1, 5),
            ("Cleric_Use_Front_", 1, 5),
            ("Cleric_Use_Side_", 1, 5),
            
            ("Cleric_Cast_Back_", 1, 7),
            ("Cleric_Cast_Front_", 1, 7),
            ("Cleric_Cast_Side_", 1, 7)]
    ...
    ///
    init() {
        super.init(identifier: ClericAnimationSet._identifier)
    ...
    private func addIdle() {
        ...
        images = ImageArray.createFrom(baseName: "Cleric_Idle_Back_", first: 1, last: 7, reversing: true,
                                       dropFirst: false)
        ...
        images = ImageArray.createFrom(baseName: "Cleric_Idle_Front_", first: 1, last: 7, reversing: true,
                                       dropFirst: false)
        ...
        images = ImageArray.createFrom(baseName: "Cleric_Idle_Side_", first: 1, last: 7, reversing: true,
                                       dropFirst: false)
    ...
    private func addWalk() {
        ...
        images = ImageArray.createFrom(baseName: "Cleric_Walk_Back_", first: 1, last: 11, reversing: true)
        let north = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                     repeatForever: true)
        addAnimation(north, named: .walk, forDirection: .north)
        
        images = ImageArray.createFrom(baseName: "Cleric_Walk_Front_", first: 1, last: 11, reversing: true)
        let south = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                     repeatForever: true)
        addAnimation(south, named: .walk, forDirection: .south)
        
        images = ImageArray.createFrom(baseName: "Cleric_Walk_Side_", first: 1, last: 11, reversing: true)
        let east = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                    repeatForever: true)
    ...
    private func addLift() {
        ...
        images = ImageArray.createFrom(baseName: "Cleric_Lift_Back_", first: 1, last: 5)
        let north = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                     repeatForever: false)
        addAnimation(north, named: .lift, forDirection: .north)
        
        images = ImageArray.createFrom(baseName: "Cleric_Lift_Front_", first: 1, last: 5)
        let south = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                     repeatForever: false)
        addAnimation(south, named: .lift, forDirection: .south)
        
        images = ImageArray.createFrom(baseName: "Cleric_Lift_Side_", first: 1, last: 5)
        let east = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                    repeatForever: false)
    ...
    private func addCarry() {
        ...
        images = ImageArray.createFrom(baseName: "Cleric_Carry_Back_", first: 1, last: 11, reversing: true)
        ...
        images = ImageArray.createFrom(baseName: "Cleric_Carry_Front_", first: 1, last: 11, reversing: true)
        ...
        images = ImageArray.createFrom(baseName: "Cleric_Carry_Side_", first: 1, last: 11, reversing: true)
    ...
    private func addHurl() {
        ...
        images = ImageArray.createFrom(baseName: "Cleric_Hurl_Back_", first: 1, last: 5)
        ...
        images = ImageArray.createFrom(baseName: "Cleric_Hurl_Front_", first: 1, last: 5)
        ...
        images = ImageArray.createFrom(baseName: "Cleric_Hurl_Side_", first: 1, last: 5)
    ...
    private func addAttack() {
        ...
        images = ImageArray.createFrom(baseName: "Cleric_Attack_Back_", first: 1, last: 7)
        ...
        images = ImageArray.createFrom(baseName: "Cleric_Attack_Front_", first: 1, last: 7)
        ...
        images = ImageArray.createFrom(baseName: "Cleric_Attack_Side_", first: 1, last: 7)
    ...
    private func addAim() {
        ...
        images = ImageArray.createFrom(baseName: "Cleric_Aim_Back_", first: 1, last: 5)
        let north = TextureAnimation(images: images, timePerFrame: 0.033, replaceable: true, flipped: false,
                                     repeatForever: false)
        addAnimation(north, named: .aim, forDirection: .north)
        
        images = ImageArray.createFrom(baseName: "Cleric_Aim_Front_", first: 1, last: 5)
        let south = TextureAnimation(images: images, timePerFrame: 0.033, replaceable: true, flipped: false,
                                     repeatForever: false)
        addAnimation(south, named: .aim, forDirection: .south)
        
        images = ImageArray.createFrom(baseName: "Cleric_Aim_Side_", first: 1, last: 5)
        let east = TextureAnimation(images: images, timePerFrame: 0.033, replaceable: true, flipped: false,
                                    repeatForever: false)
    ...
    private func addShoot() {
        ...
        images = ImageArray.createFrom(baseName: "Cleric_Shoot_Back_", first: 1, last: 5)
        let north = TextureAnimation(images: images, timePerFrame: 0.033, replaceable: true, flipped: false,
                                     repeatForever: false)
        addAnimation(north, named: .shoot, forDirection: .north)
        
        images = ImageArray.createFrom(baseName: "Cleric_Shoot_Front_", first: 1, last: 5)
        let south = TextureAnimation(images: images, timePerFrame: 0.033, replaceable: true, flipped: false,
                                     repeatForever: false)
        addAnimation(south, named: .shoot, forDirection: .south)
        
        images = ImageArray.createFrom(baseName: "Cleric_Shoot_Side_", first: 1, last: 5)
        let east = TextureAnimation(images: images, timePerFrame: 0.033, replaceable: true, flipped: false,
                                    repeatForever: false)
    ...
    private func addDirect() {
        ...
        images = ImageArray.createFrom(baseName: "Cleric_Direct_Back_", first: 1, last: 5)
        let north = TextureAnimation(images: images, timePerFrame: 0.033, replaceable: true, flipped: false,
                                     repeatForever: false)
        addAnimation(north, named: .direct, forDirection: .north)
        
        images = ImageArray.createFrom(baseName: "Cleric_Direct_Front_", first: 1, last: 5)
        let south = TextureAnimation(images: images, timePerFrame: 0.033, replaceable: true, flipped: false,
                                     repeatForever: false)
        addAnimation(south, named: .direct, forDirection: .south)
        
        images = ImageArray.createFrom(baseName: "Cleric_Direct_Side_", first: 1, last: 5)
        let east = TextureAnimation(images: images, timePerFrame: 0.033, replaceable: true, flipped: false,
                                    repeatForever: false)
    ...
    private func addToss() {
        ...
        images = ImageArray.createFrom(baseName: "Cleric_Toss_Back_", first: 1, last: 5)
        let north = TextureAnimation(images: images, timePerFrame: 0.033, replaceable: true, flipped: false,
                                     repeatForever: false)
        addAnimation(north, named: .toss, forDirection: .north)
        
        images = ImageArray.createFrom(baseName: "Cleric_Toss_Front_", first: 1, last: 5)
        let south = TextureAnimation(images: images, timePerFrame: 0.033, replaceable: true, flipped: false,
                                     repeatForever: false)
        addAnimation(south, named: .toss, forDirection: .south)
        
        images = ImageArray.createFrom(baseName: "Cleric_Toss_Side_", first: 1, last: 5)
        let east = TextureAnimation(images: images, timePerFrame: 0.033, replaceable: true, flipped: false,
                                    repeatForever: false)
    ...
    private func addUse() {
        ...
        images = ImageArray.createFrom(baseName: "Cleric_Use_Back_", first: 1, last: 5)
        let north = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                     repeatForever: false)
        addAnimation(north, named: .use, forDirection: .north)
        
        images = ImageArray.createFrom(baseName: "Cleric_Use_Front_", first: 1, last: 5)
        let south = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                     repeatForever: false)
        addAnimation(south, named: .use, forDirection: .south)
        
        images = ImageArray.createFrom(baseName: "Cleric_Use_Side_", first: 1, last: 5)
        let east = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                    repeatForever: false)
    ...
    private func addUseEnd() {
        ...
        images = ImageArray.createFrom(baseName: "Cleric_Use_Back_", first: 5, last: 1)
        let north = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                     repeatForever: false)
        addAnimation(north, named: .useEnd, forDirection: .north)
        
        images = ImageArray.createFrom(baseName: "Cleric_Use_Front_", first: 5, last: 1)
        let south = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                     repeatForever: false)
        addAnimation(south, named: .useEnd, forDirection: .south)
        
        images = ImageArray.createFrom(baseName: "Cleric_Use_Side_", first: 5, last: 1)
        let east = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                    repeatForever: false)
    ...
    private func addCast() {
        ...
        images = ImageArray.createFrom(baseName: "Cleric_Cast_Back_", first: 1, last: 7)
        let north = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                     repeatForever: false)
        addAnimation(north, named: .cast, forDirection: .north)
        
        images = ImageArray.createFrom(baseName: "Cleric_Cast_Front_", first: 1, last: 7)
        let south = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                     repeatForever: false)
        addAnimation(south, named: .cast, forDirection: .south)
        
        images = ImageArray.createFrom(baseName: "Cleric_Cast_Side_", first: 1, last: 7)
        let east = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                    repeatForever: false)
    ...
    private func addCastEnd() {
        ...
        images = ImageArray.createFrom(baseName: "Cleric_Cast_Back_", first: 7, last: 1)
        let north = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                     repeatForever: false)
        addAnimation(north, named: .castEnd, forDirection: .north)
        
        images = ImageArray.createFrom(baseName: "Cleric_Cast_Front_", first: 7, last: 1)
        let south = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                     repeatForever: false)
        addAnimation(south, named: .castEnd, forDirection: .south)
        
        images = ImageArray.createFrom(baseName: "Cleric_Cast_Side_", first: 7, last: 1)
        let east = TextureAnimation(images: images, timePerFrame: 0.05, replaceable: true, flipped: false,
                                    repeatForever: false)
