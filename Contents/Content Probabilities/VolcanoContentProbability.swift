//
//  VolcanoContentProbability.swift
...
/// The `ContentProbability` instances for the Volcano.
///
struct VolcanoContentProbability {
    ...
    static let oneTime: [ContentProbability] = [OneTimeMerchant(), OneTimeElite(), OneTimeRare(), OneTimeTrap(),
                                                ...
                                                OneTimeDiseasePool(), OneTimeGigas(), OneTimePack()]
    ...
    private class OneTimeDiseasePool: ContentProbability {
        ...
        init() {
            let rules: [ContentType: ContentRule] = [
                ...
                .treasure: ContentRule(creationRule: .noMoreThanOnce, localizationRule: .mainRoom,
                                       placementRule: .edge),
                .other("Vermin"): ContentRule(creationRule: .atLeastOnce, localizationRule: .any,
                                              placementRule: .any),
                .other("Disease Pool"): ContentRule(creationRule: .atLeastOnce, localizationRule: .mainRoom,
                                                    placementRule: .any)
            ]
            
            let weights: [ContentType: Double] = [.destructible: 0.1, .treasure: 0.025, .other("Vermin"): 1.0,
                                                  .other("Disease Pool"): 0.3]
    ...
    private class OneTimeGigas: ContentProbability {
        ...
        init() {
            let rules: [ContentType: ContentRule] = [
                ...
                .trap: ContentRule(creationRule: .atLeastOnce, localizationRule: .any, placementRule: .middle),
                .treasure: ContentRule(creationRule: .noMoreThanOnce, localizationRule: .any, placementRule: .middle),
                .other("Gigas"): ContentRule(creationRule: .atLeastOnce, localizationRule: .mainRoom,
                                             placementRule: .any)
            ]
            
            let weights: [ContentType: Double] = [.destructible: 1.0, .trap: 0.1, .treasure: 0.1,
                                                  .other("Gigas"): 0.6]
    ...
    private class OneTimePack: ContentProbability {
        ...
        init() {
            let rules: [ContentType: ContentRule] = [
                .destructible: ContentRule(creationRule: .any, localizationRule: .any, placementRule: .edge),
                .trap: ContentRule(creationRule: .any, localizationRule: .any, placementRule: .middle),
                .treasure: ContentRule(creationRule: .atLeastOnce, localizationRule: .mainRoom, placementRule: .any),
                .other("Hell Hound"): ContentRule(creationRule: .atLeastOnce, localizationRule: .mainRoom,
                                                  placementRule: .any)
            ]
            
            let weights: [ContentType: Double] = [.destructible: 1.0, .trap: 0.075, .treasure: 0.075,
                                                  .other("Hell Hound"): 0.3]
