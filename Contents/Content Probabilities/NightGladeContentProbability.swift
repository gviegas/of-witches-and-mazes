//
//  NightGladeContentProbability.swift
...
/// The `ContentProbability` instances for the Night Glade.
///
struct NightGladeContentProbability {
    ...
    private class OneTimeAcidPool: ContentProbability {
        
        init() {
            let rules: [ContentType: ContentRule] = [
                .destructible: ContentRule(creationRule: .any, localizationRule: .any, placementRule: .edge),
                .treasure: ContentRule(creationRule: .exactlyOnce, localizationRule: .mainRoom, placementRule: .edge),
                .other("Dispelling Trap"): ContentRule(creationRule: .any, localizationRule: .any,
                                                       placementRule: .any),
                .other("Acid Pool"): ContentRule(creationRule: .atLeastOnce, localizationRule: .any,
                                                 placementRule: .any),
                .other("Death Cap"): ContentRule(creationRule: .atLeastOnce, localizationRule: .any,
                                                 placementRule: .any)
            ]
            
            let weights: [ContentType: Double] = [.destructible: 0.65, .other("Dispelling Trap"): 0.1,
                                                  .other("Acid Pool"): 0.45, .other("Death Cap"): 1.0]
    ...
    private class OneTimePack: ContentProbability {
        ...
        init() {
            let rules: [ContentType: ContentRule] = [
                .destructible: ContentRule(creationRule: .any, localizationRule: .any, placementRule: .edge),
                .treasure: ContentRule(creationRule: .exactlyOnce, localizationRule: .mainRoom, placementRule: .any),
                .other("Feralon"): ContentRule(creationRule: .exactlyOnce, localizationRule: .mainRoom,
                                               placementRule: .any),
                .other("Feral"): ContentRule(creationRule: .atLeastOnce, localizationRule: .mainRoom,
                                             placementRule: .any)
            ]
            
            let weights: [ContentType: Double] = [.destructible: 1.0, .other("Feral"): 1.0]
