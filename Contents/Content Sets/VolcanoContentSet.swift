...
/// The `ContentSet` for the Volcano.
///
class VolcanoContentSet: ContentSet, TextureUser, AnimationUser {
    ...
    ///
    static let instance = VolcanoContentSet()
    ...
    func makeContent(ofType type: ContentType) -> Content? {
        ...
        case .other(let name) where name == "Disease Pool":
            content = Content(type: type, isDynamic: false, isObstacle: false,
                              entity: DiseasePool(levelOfExperience: Game.levelOfExperience!))
        case .other(let name) where name == "Vermin":
            content = Content(type: type, isDynamic: true, isObstacle: false,
                              entity: Vermin(levelOfExperience: Game.levelOfExperience!))
        case .other(let name) where name == "Gigas":
            content = Content(type: type, isDynamic: true, isObstacle: false,
                              entity: Gigas(levelOfExperience: Game.levelOfExperience!))
        case .other(let name) where name == "Hell Hound":
            content = Content(type: type, isDynamic: true, isObstacle: false,
                              entity: HellHound(levelOfExperience: Game.levelOfExperience!))
...
private class RandomDestructible: TextureUser, AnimationUser {
    ...
    private static let values: [(InanimateObject.Type, Double)] = [
        (Crate.self, 1.0),
        (ReinforcedCrate.self, 0.2),
        (IronCrate.self, 0.1),
        (Barrel.self, 0.7),
        (ExplosiveBarrel.self, 0.3)]
...
private class RandomEnemy: TextureUser, AnimationUser {
    ...
    class func next(levelOfExperience: Int) -> Content? {
        ...
        switch distr.nextValue() {
        case is Azollyan.Type:
            entity = Azollyan(levelOfExperience: levelOfExperience)
        case is Theraxyan.Type:
            entity = Theraxyan(levelOfExperience: levelOfExperience)
        case is Vermin.Type:
            entity = Vermin(levelOfExperience: levelOfExperience)
        case is Bat.Type:
            entity = Bat(levelOfExperience: levelOfExperience)
        case is Gigas.Type:
            entity = Gigas(levelOfExperience: levelOfExperience)
        default:
            entity = nil
        }
...
private class RandomRare: TextureUser, AnimationUser {
    ...
    class func next(levelOfExperience: Int) -> Content? {
        ...
        switch distr.nextValue() {
        case is HellHound.Type:
            entity = HellHound(levelOfExperience: levelOfExperience)
...
private class RandomTrap: TextureUser, AnimationUser {
    ...
    class func next(levelOfExperience: Int) -> Content? {
        ...
        switch distr.nextValue() {
        case is LavaPool.Type:
            entity = LavaPool(levelOfExperience: levelOfExperience)
