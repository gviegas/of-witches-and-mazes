...
/// An `EntityState` subclass representing the state of a `Companion` when dying.
///
class CompanionDeathState: EntityState {
    
    private var nodeComponent: NodeComponent {
        guard let component = entity.component(ofType: NodeComponent.self) else {
            fatalError("An entity assigned to CompanionDeathState must have a NodeComponent")
        }
        return component
    }
    ...
    private var movementComponent: MovementComponent {
        guard let component = entity.component(ofType: MovementComponent.self) else {
            fatalError("An entity assigned to CompanionDeathState must have a MovementComponent")
        }
        return component
    }
    ...
    private var spriteComponent: SpriteComponent {
        guard let component = entity.component(ofType: SpriteComponent.self) else {
            fatalError("An entity assigned to CompanionDeathState must have a SpriteComponent")
        }
        return component
    }
    ...
    private var physicsComponent: PhysicsComponent {
        guard let component = entity.component(ofType: PhysicsComponent.self) else {
            fatalError("An entity assigned to CompanionDeathState must have a PhysicsComponent")
        }
        return component
    }
    ...
    private var statusBarComponent: StatusBarComponent {
        guard let component = entity.component(ofType: StatusBarComponent.self) else {
            fatalError("An entity assigned to CompanionDeathState must have a StatusBarComponent")
        }
        return component
    }
    ...
    private var conditionComponent: ConditionComponent {
        guard let component = entity.component(ofType: ConditionComponent.self) else {
            fatalError("An entity assigned to CompanionDeathState must have a ConditionComponent")
        }
        return component
    }
