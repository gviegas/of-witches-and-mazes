...
/// A `EntityState` subclass representing the state of a `Companion` when quelled.
///
class CompanionQuelledState: EntityState {
    
    private var movementComponent: MovementComponent {
        guard let component = entity.component(ofType: MovementComponent.self) else {
            fatalError("An entity assigned to CompanionQuelledState must have a MovementComponent")
        }
        return component
    }
    ...
    private var spriteComponent: SpriteComponent {
        guard let component = entity.component(ofType: SpriteComponent.self) else {
            fatalError("An entity assigned to CompanionQuelledState must have a SpriteComponent")
        }
        return component
    }
    ...
    private var perceptionComponent: PerceptionComponent {
        guard let component = entity.component(ofType: PerceptionComponent.self) else {
            fatalError("An entity assigned to CompanionQuelledState must have a PerceptionComponent")
        }
        return component
    }
    ...
    private var vulnerabilityComponent: VulnerabilityComponent {
        guard let component = entity.component(ofType: VulnerabilityComponent.self) else {
            fatalError("An entity assigned to CompanionQuelledState must have a VulnerabilityComponent")
        }
        return component
    }
    ...
    private var quellComponent: QuellComponent {
        guard let component = entity.component(ofType: QuellComponent.self) else {
            fatalError("An entity assigned to CompanionQuelledState must have a QuellComponent")
        }
        return component
    }
