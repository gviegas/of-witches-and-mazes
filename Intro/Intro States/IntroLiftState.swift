...
/// A `ControllabeEntityState` subclass representing the lift state during the introduction.
///
class IntroLiftState: ControllableEntityState {
    
    private var movementComponent: MovementComponent {
        guard let component = entity.component(ofType: MovementComponent.self) else {
            fatalError("An entity assigned to IntroLiftState must have a MovementComponent")
        }
        return component
    }
    ...
    private var directionComponent: DirectionComponent {
        guard let component = entity.component(ofType: DirectionComponent.self) else {
            fatalError("An entity assigned to IntroLiftState must have a DirectionComponent")
        }
        return component
    }
    ...
    private var spriteComponent: SpriteComponent {
        guard let component = entity.component(ofType: SpriteComponent.self) else {
            fatalError("An entity assigned to IntroLiftState must have a SpriteComponent")
        }
        return component
    }
    ...
    private var physicsComponent: PhysicsComponent {
        guard let component = entity.component(ofType: PhysicsComponent.self) else {
            fatalError("An entity assigned to IntroLiftState must have a PhysicsComponent")
        }
        return component
    }
    ...
    private var targetComponent: TargetComponent {
        guard let component = entity.component(ofType: TargetComponent.self) else {
            fatalError("An entity assigned to IntroLiftState must have a TargetComponent")
        }
        return component
    }
    ...
    private var liftComponent: LiftComponent {
        guard let component = entity.component(ofType: LiftComponent.self) else {
            fatalError("An entity assigned to IntroLiftState must have a LiftComponent")
        }
        return component
    }
    ...
    private func resumeMovement() {
        if InputManager.isPressed(inputButton: .right) {
            ...
            spriteComponent.animate(name: .hold)
        }
    }
    ...
    override func willExit(to nextState: GKState) {
        ...
        guard nextState is IntroHurlState else {
